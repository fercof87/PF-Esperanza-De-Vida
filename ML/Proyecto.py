...
# Etapas del Proyecto
st.header("Etapas del Proyecto")

# 1. Data Analysis (Sprint #1)
st.subheader("1. Data Analysis (Sprint #1)")
st.markdown(
    """
...
# 2. Data Engineering (Sprint #2)
st.subheader("2. Data Engineering (Sprint #2)")
st.markdown(
    """
...
# 3. Data Analytics + MLOps (Sprint #3)
st.subheader("3. Data Analytics + MLOps (Sprint #3)")
st.markdown(
    """
...
st.markdown(
    """
    - **Google Cloud Storage**: Utilizado para la persistencia de los archivos no estructurados, será utilizado como DL(Data Lake).
    - **Google Big Query**:  Utilizado para la persistencia de los archivos estructurados, será utilizado como DW(Data WareHouse).
...
st.markdown(
    ...
    - **openpyxl**: Para la lectura y manipulación de archivos xlsx.
    """
)

# Organización del Repositorio
st.header("Organización del Repositorio")
st.markdown(
    """
    - **Datos**: Aquí están todos los archivos generados en el proceso de ETL/EDA como así también los inputs de provenientes del banco mundial de datos.
    ...
    - **Docs. Management y Funcional**: Directorio que contiene toda la documentación de gestión de proyecto. Además, se podrán encontrar los archivos de documentación funcional.
    """
)
